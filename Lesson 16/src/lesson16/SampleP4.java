...
public class SampleP4 extends Frame implements Runnable//フレームクラスを拡張します
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		SampleP4 sm = new SampleP4(); //拡張したクラスからオブジェクトを作成します。

	}
	public SampleP4() throws MalformedURLException
	{
