...
public class SampleP3 extends Frame implements Runnable//フレームクラスを拡張します
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		SampleP3 sm = new SampleP3(); //拡張したクラスからオブジェクトを作成します。

	}
	public SampleP3() throws MalformedURLException
	{
...
//		g.fillRect(50, 50, 100, 100); //p517 LessonP2
		
		g.drawImage(p3im, x,y,this); //LessonP3
